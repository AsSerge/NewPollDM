                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-primary">
                        <div class="panel-heading" role="tab" id="heading1">
                            ...
                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1"><span class="glyphicon glyphicon glyphicon-picture"></span>&nbsp;Главное фото [список продукции]</a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="heading2">
                                <h4 class="panel-title">
                                        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse2" aria-expanded="false" aria-controls="collapse2"><span class="glyphicon glyphicon-th-large"></span>&nbsp;Карточка товара [дополнительные фото]</a>
                                </h4>
                        </div>
                    ...
                    if($cfs){
                        ...
                        echo "<p class='text-info'>Необходимо добавить изображения!</p>";
                    }
                    ?>
                                 </div>
                        ...
                        <?php
                        //Подключаем по необходимости редактор карты цветов
                        if($row_m['relationship'] === 'ParentRainbow' ){
                            include_once('СolorСard.php');
                        }
                        ?>
                </div> 
            </div>
