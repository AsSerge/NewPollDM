<?php
$name='Serge Tsvetkoff'; // Имя получателя
$mail='zoom@tk-ug.ru'; // Адрес получателя
$subject='Опрос по теме Поездка в Хельсинки'; // Тема сообщения
$message="<strong>Тестовое</strong> сообщение. Расцветали Yaблони и <a href = '#'>груши</a>"; // Сообщение

$sender_mail='Tsvetkov-SA@dmtextile.ru'; // Почта отправителя
$sender_name='Цветков Сергей'; // Имя отправителя
...
function SendMailGRMP($mail, $subject, $message, $sender_mail, $sender_name){
    ...
    require_once '../../_prog/polls/PHPMailer/PHPMailerAutoload.php';
    $SendAdress = array(
        'name'=>$name,
        'mail'=>$mail,
        'subject'=>$subject,
